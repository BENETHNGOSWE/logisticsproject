 ...
 <section class="about-section fix section-padding" id="about">
    <div class="about-shape-4 float-bob-x">
        <img src="assets/img/about/about-shape-4.png" alt="img">
    </div>
    <div class="about-shape-5 float-bob-y">
                ...
                <div class="col-lg-6">
                    <div class="about-image">
                        ...
                        <div class="video-items wow fadeInUp">
                            ...
                            <a href="https://www.youtube.com/watch?v=Cn4G2lZ_g2I" class="video-text video-popup">
                                play now
                            </a>
                        </div>
                        <div class="bar-shape">
                ...
                <div class="col-lg-6">
                    <div class="about-content">
                        ...
                        <div class="about-author">
                            <a href="#" class="theme-btn wow fadeInUp" data-wow-delay=".2s">Explore more
                                <i class="fa-regular fa-arrow-right"></i></a>
                            <div class="author-image wow fadeInUp" data-wow-delay=".4s">
                                {{-- <img src="assets/img/about/profile.jpg" alt="author-img" width="100" height="100"> --}}
                                <div class="content">
                                    <p>Koda, CEO</p>
                                    <h4>Beneth Emmanuel</h4>
                                </div>
                            </div>
                        </div>
                    </div>
